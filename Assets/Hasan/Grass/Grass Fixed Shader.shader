...
Shader "Grass Fixed Shader 1"
{
	Properties
	{
		...
		_WindDensityScale("Wind Density Scale", Float) = 5
		_WindSpeed("Wind Speed", Vector) = (1,1,0,0)
		[HDR]_HighlightColor("Highlight Color", Color) = (0.9056604,0.2747056,0.1913848,0)
		_HighlightMaskStrength("Highlight Mask Strength", Range( 0 , 1)) = 1
		[ASEEnd]_MaskStrength("Mask Strength", Float) = 0.37
	...
	SubShader
	{
		...
		Pass
		{
			...
			float2 _WindSpeed;
			float _WindDensityScale;
			float _MaskStrength;
			float _Windstrength;
			float _HighlightMaskStrength;
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 panner34 = ( ( _TimeParameters.x ) * _WindSpeed + ase_worldPos.xy);
				float simpleNoise23 = SimpleNoise( panner34*_WindDensityScale );
				float4 appendResult57 = (float4(( ( ( ( simpleNoise23 - _MaskStrength ) * ( simpleNoise23 * _Windstrength ) ) + 0.0 ) + inputMesh.positionOS.x ) , inputMesh.positionOS.y , inputMesh.positionOS.z , 0.0));
				float2 texCoord54 = inputMesh.uv1.xy * float2( 1,1 ) + float2( 0,0 );
				...
				#endif
				float3 vertexValue = ( appendResult57 * texCoord54.y ).xyz;
						...
						)
			{
				...
				Gradient gradient13 = NewGradient( 0, 2, 2, float4( 0.1981488, 0.4339623, 0.3351893, 0 ), float4( 0.7430337, 0.8490566, 0.3075827, 1 ), 0, 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				float2 texCoord14 = packedInput.interp03.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord85 = packedInput.interp03.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner86 = ( ( _TimeParameters.x ) * _WindSpeed + texCoord85);
				float simpleNoise87 = SimpleNoise( panner86*_WindDensityScale );
				float temp_output_98_0 = ( simpleNoise87 - _MaskStrength );
				float4 lerpResult67 = lerp( SampleGradient( gradient13, texCoord14.y ) , ( _HighlightColor * temp_output_98_0 ) , ( temp_output_98_0 * ( texCoord14.y * _HighlightMaskStrength ) ));
				
				float2 uv_Normal = packedInput.ase_texcoord5.xy * _Normal_ST.xy + _Normal_ST.zw;
				
				float2 uv_AlphaClip = packedInput.ase_texcoord5.xy * _AlphaClip_ST.xy + _AlphaClip_ST.zw;
				
				surfaceDescription.Albedo = lerpResult67.rgb;
				...
				surfaceDescription.Alpha = tex2D( _AlphaClip, uv_AlphaClip ).r;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_Normal = packedInput.ase_texcoord.zw * _Normal_ST.xy + _Normal_ST.zw;
				
				float2 uv_AlphaClip = packedInput.ase_texcoord.zw * _AlphaClip_ST.xy + _AlphaClip_ST.zw;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float simpleNoise23 = SimpleNoise( panner34*_WindDensityScale );
				float4 appendResult57 = (float4(( ( ( ( simpleNoise23 - _MaskStrength ) * ( simpleNoise23 * _Windstrength ) ) + 0.0 ) + inputMesh.positionOS.x ) , inputMesh.positionOS.y , inputMesh.positionOS.z , 0.0));
				float2 texCoord54 = inputMesh.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
					...
					)
			{
				...
				float2 uv_AlphaClip = packedInput.ase_texcoord1.xy * _AlphaClip_ST.xy + _AlphaClip_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_AlphaClip = packedInput.ase_texcoord3.xy * _AlphaClip_ST.xy + _AlphaClip_ST.zw;
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_AlphaClip = packedInput.ase_texcoord7.xy * _AlphaClip_ST.xy + _AlphaClip_ST.zw;
...
/*ASEBEGIN
Version=18921
112;216.8;1062.4;563;6707.859;3172.488;10.12764;True;False
Node;AmplifyShaderEditor.WorldPosInputsNode;27;-2434.229,-1354.628;Inherit;True;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.Vector2Node;35;-2387.419,-1116.725;Inherit;False;Property;_WindSpeed;Wind Speed;4;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TimeNode;36;-2389.206,-947.9604;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PannerNode;34;-2093.23,-1149.153;Inherit;True;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;32;-2035.93,-888.8375;Inherit;False;Property;_WindDensityScale;Wind Density Scale;3;0;Create;True;0;0;0;False;0;False;5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;103;-1694.725,-1338.046;Inherit;False;Property;_MaskStrength;Mask Strength;7;0;Create;True;0;0;0;False;0;False;0.37;0.37;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;23;-1721.501,-1155.488;Inherit;True;Simple;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;31;-1621.384,-891.8561;Inherit;False;Property;_Windstrength;Wind strength;2;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;29;-1386.051,-1111.785;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;102;-1389.275,-1364.551;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;85;-2319.204,-86.12805;Inherit;False;1;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;104;-1090.117,-1262.234;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;86;-1876.065,-85.97699;Inherit;True;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleAddOpNode;50;-771.5211,-1091.259;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;14;-1398.365,538.5638;Inherit;True;1;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.NoiseGeneratorNode;87;-1300.041,-88.22578;Inherit;True;Simple;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.PosVertexDataNode;60;-741.5677,-869.7997;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;95;-828.724,646.1058;Inherit;False;Property;_HighlightMaskStrength;Highlight Mask Strength;6;0;Create;True;0;0;0;False;0;False;1;0.4470588;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;98;-926.1729,-89.83033;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;65;-915.3725,141.2086;Inherit;False;Property;_HighlightColor;Highlight Color;5;1;[HDR];Create;True;0;0;0;False;0;False;0.9056604,0.2747056,0.1913848,0;0.9056604,0.2747056,0.1913848,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;59;-341.7065,-859.251;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GradientNode;13;-1408.116,377.2352;Inherit;False;0;2;2;0.1981488,0.4339623,0.3351893,0;0.7430337,0.8490566,0.3075827,1;1,0;1,1;0;1;OBJECT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;94;-432.859,582.1234;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;57;30.61592,-849.3126;Inherit;True;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.GradientSampleNode;15;-795.2368,357.2475;Inherit;True;2;0;OBJECT;;False;1;FLOAT;0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;101;-136.1212,242.169;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;54;37.37397,-611.776;Inherit;True;1;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;93;-500.7468,-112.965;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;62;458.4789,-856.0753;Inherit;True;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SamplerNode;11;546.4537,508.9204;Inherit;True;Property;_AlphaClip;Alpha Clip;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ComponentMaskNode;66;1032.373,-168.3498;Inherit;False;True;True;True;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.LerpOp;67;102.4817,-136.7578;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;12;520.3855,299.0119;Inherit;True;Property;_Normal;Normal;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=E32430791A075FA760CC27F0B9AFEE15F1CAB99D