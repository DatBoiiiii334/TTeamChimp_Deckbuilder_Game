...
Shader "Tree Leaves Shaders"
{
	Properties
	{
		...
		[ASEEnd]_LeafGradient("Leaf Gradient", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 uv_LeafGradient = inputMesh.ase_texcoord.xy * _LeafGradient_ST.xy + _LeafGradient_ST.zw;
				...
				#endif
				float3 vertexValue = ( tex2Dlod( _WindNoise, float4( panner20, 0, 0.0) ) * ( tex2Dlod( _LeafGradient, float4( uv_LeafGradient, 0, 0.0) ) * _MaskStrength ) ).rgb;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 appendResult47 = (float2(ase_worldPos.x , ase_worldPos.y));
				float2 panner20 = ( ( _WindSpeed * _TimeParameters.x ) * float2( 1,1 ) + ( appendResult47 * _NoiseTiling ));
				float2 uv_LeafGradient = inputMesh.uv0.xy * _LeafGradient_ST.xy + _LeafGradient_ST.zw;
...
/*ASEBEGIN
Version=18933
64.8;679.2;1103.2;595.8;1693.47;955.121;2.272848;True;False
...
Node;AmplifyShaderEditor.SamplerNode;48;-858.022,-581.1962;Inherit;True;Property;_LeafGradient;Leaf Gradient;7;0;Create;True;0;0;0;False;0;False;-1;61946c2eb1550084ea7f3c79d6adefdc;61946c2eb1550084ea7f3c79d6adefdc;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;45;-736.1481,-358.2094;Inherit;False;Property;_MaskStrength;Mask Strength;6;0;Create;True;0;0;0;False;0;False;1;0.4082074;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;44;-473.639,-483.5929;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=98E20E981B333430C78CE5F44B961AECF29F894E