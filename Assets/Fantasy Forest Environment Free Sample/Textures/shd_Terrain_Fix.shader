...
Shader "shd_Terrain_Fix"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		_Texture4("Texture 2", 2D) = "white" {}
		_Texture2NormalMap2("Texture 2 Normal Map", 2D) = "bump" {}
		_Texture3("Texture 1", 2D) = "white" {}
		_TextureNormalMap2("Texture 1 Normal Map", 2D) = "bump" {}
		_Metallic2("Metallic", Range( 0 , 1)) = 0
		_Smoothness2("Smoothness", Range( 0 , 1)) = 0
		_NormalMapStrength2("Normal Map 1 Strength", Float) = 1
		[ASEEnd]_NormalMap2Strength2("Normal Map 2 Strength", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Texture3_ST;
			float4 _Texture4_ST;
			float4 _TextureNormalMap2_ST;
			float4 _Texture2NormalMap2_ST;
			float _NormalMapStrength2;
			float _NormalMap2Strength2;
			float _Metallic2;
			float _Smoothness2;
			...
			sampler2D _Texture3;
			sampler2D _Texture4;
			sampler2D _TextureNormalMap2;
			sampler2D _Texture2NormalMap2;
						...
						)
			{
				...
				float2 uv_Texture3 = packedInput.ase_texcoord5.xy * _Texture3_ST.xy + _Texture3_ST.zw;
				float2 uv_Texture4 = packedInput.ase_texcoord5.xy * _Texture4_ST.xy + _Texture4_ST.zw;
				float4 lerpResult22 = lerp( tex2D( _Texture3, uv_Texture3 ) , tex2D( _Texture4, uv_Texture4 ) , packedInput.ase_color.r);
				
				float2 uv_TextureNormalMap2 = packedInput.ase_texcoord5.xy * _TextureNormalMap2_ST.xy + _TextureNormalMap2_ST.zw;
				float2 uv_Texture2NormalMap2 = packedInput.ase_texcoord5.xy * _Texture2NormalMap2_ST.xy + _Texture2NormalMap2_ST.zw;
				float3 lerpResult21 = lerp( ( UnpackNormalScale( tex2D( _TextureNormalMap2, uv_TextureNormalMap2 ), 1.0f ) * _NormalMapStrength2 ) , ( UnpackNormalScale( tex2D( _Texture2NormalMap2, uv_Texture2NormalMap2 ), 1.0f ) * _NormalMap2Strength2 ) , packedInput.ase_color.r);
				float3 normalizeResult25 = normalize( lerpResult21 );
				
				surfaceDescription.Albedo = lerpResult22.rgb;
				surfaceDescription.Normal = normalizeResult25;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = _Metallic2;
				...
				surfaceDescription.Smoothness = _Smoothness2;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_Texture3 = packedInput.ase_texcoord.xy * _Texture3_ST.xy + _Texture3_ST.zw;
				float2 uv_Texture4 = packedInput.ase_texcoord.xy * _Texture4_ST.xy + _Texture4_ST.zw;
				float4 lerpResult22 = lerp( tex2D( _Texture3, uv_Texture3 ) , tex2D( _Texture4, uv_Texture4 ) , packedInput.ase_color.r);
				
				float2 uv_TextureNormalMap2 = packedInput.ase_texcoord.xy * _TextureNormalMap2_ST.xy + _TextureNormalMap2_ST.zw;
				float2 uv_Texture2NormalMap2 = packedInput.ase_texcoord.xy * _Texture2NormalMap2_ST.xy + _Texture2NormalMap2_ST.zw;
				float3 lerpResult21 = lerp( ( UnpackNormalScale( tex2D( _TextureNormalMap2, uv_TextureNormalMap2 ), 1.0f ) * _NormalMapStrength2 ) , ( UnpackNormalScale( tex2D( _Texture2NormalMap2, uv_Texture2NormalMap2 ), 1.0f ) * _NormalMap2Strength2 ) , packedInput.ase_color.r);
				float3 normalizeResult25 = normalize( lerpResult21 );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_TextureNormalMap2 = packedInput.ase_texcoord3.xy * _TextureNormalMap2_ST.xy + _TextureNormalMap2_ST.zw;
				float2 uv_Texture2NormalMap2 = packedInput.ase_texcoord3.xy * _Texture2NormalMap2_ST.xy + _Texture2NormalMap2_ST.zw;
				float3 lerpResult21 = lerp( ( UnpackNormalScale( tex2D( _TextureNormalMap2, uv_TextureNormalMap2 ), 1.0f ) * _NormalMapStrength2 ) , ( UnpackNormalScale( tex2D( _Texture2NormalMap2, uv_Texture2NormalMap2 ), 1.0f ) * _NormalMap2Strength2 ) , packedInput.ase_color.r);
				float3 normalizeResult25 = normalize( lerpResult21 );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_Texture3 = packedInput.ase_texcoord7.xy * _Texture3_ST.xy + _Texture3_ST.zw;
				float2 uv_Texture4 = packedInput.ase_texcoord7.xy * _Texture4_ST.xy + _Texture4_ST.zw;
				float4 lerpResult22 = lerp( tex2D( _Texture3, uv_Texture3 ) , tex2D( _Texture4, uv_Texture4 ) , packedInput.ase_color.r);
				
				float2 uv_TextureNormalMap2 = packedInput.ase_texcoord7.xy * _TextureNormalMap2_ST.xy + _TextureNormalMap2_ST.zw;
				float2 uv_Texture2NormalMap2 = packedInput.ase_texcoord7.xy * _Texture2NormalMap2_ST.xy + _Texture2NormalMap2_ST.zw;
				float3 lerpResult21 = lerp( ( UnpackNormalScale( tex2D( _TextureNormalMap2, uv_TextureNormalMap2 ), 1.0f ) * _NormalMapStrength2 ) , ( UnpackNormalScale( tex2D( _Texture2NormalMap2, uv_Texture2NormalMap2 ), 1.0f ) * _NormalMap2Strength2 ) , packedInput.ase_color.r);
				float3 normalizeResult25 = normalize( lerpResult21 );
...
/*ASEBEGIN
Version=18912
396.8;69.6;1062.4;557.4;3227.03;1152.54;3.627601;True;False
Node;AmplifyShaderEditor.RangedFloatNode;12;-1341.724,374.0186;Inherit;False;Property;_NormalMapStrength2;Normal Map 1 Strength;6;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;11;-1401.583,172.9377;Inherit;True;Property;_TextureNormalMap2;Texture 1 Normal Map;3;0;Create;True;0;0;0;False;0;False;-1;30ec70ef60a2bb54ea2df6f72c77bdc6;19122873fde8ac946953306cc0ad4937;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;13;-1442.219,475.6182;Inherit;True;Property;_Texture2NormalMap2;Texture 2 Normal Map;1;0;Create;True;0;0;0;False;0;False;-1;6c41a2cea80b4fc499bac2a6c14a4514;0ce960630660f47488fb2301d55907b0;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;14;-1323.249,691.5393;Inherit;False;Property;_NormalMap2Strength2;Normal Map 2 Strength;7;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;17;-998.3195,665.2548;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;16;-1033.958,120.9861;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-1086.245,503.6025;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp;21;-806.8614,130.7272;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode;19;-1402.123,-453.3014;Inherit;True;Property;_Texture3;Texture 1;2;0;Create;True;0;0;0;False;0;False;-1;30ec70ef60a2bb54ea2df6f72c77bdc6;30ec70ef60a2bb54ea2df6f72c77bdc6;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;18;-1393.961,-216.7251;Inherit;True;Property;_Texture4;Texture 2;0;0;Create;True;0;0;0;False;0;False;-1;6c41a2cea80b4fc499bac2a6c14a4514;8cedb6a9a85cf874e868f90e5045c3f6;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;20;-1286.44,-32.35396;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.NormalizeNode;25;-571.8907,129.5976;Inherit;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;24;-333.2395,188.7837;Inherit;False;Property;_Metallic2;Metallic;4;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;23;-308.6889,286.739;Inherit;False;Property;_Smoothness2;Smoothness;5;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;22;-901.5965,-251.2253;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=89C807A85C2ADE4C85CF485243AF08DAAA9A2A5A